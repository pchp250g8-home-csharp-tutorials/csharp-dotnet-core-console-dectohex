DecToHex. C# Tutorials. Simple Input/Output. Strings. Algorithms. DotNet Core Platform. Console Application.
...
The program does the following:
  ...
  9. The entered number and its hexadecimal number (the string that was declared in point 3) are displayed on the screen.
Developed in the Microsoft Visual Studio integrated environment.

DecToHex. Занятия по С#. Простой ввод/вывод. Строки. Алгоритмы. Платформа DotNet Core. Консольное приложение.
...
Программа делает следующее:
  ...
  9. На экран выводится введённое число и его шестнадцатиричное число (строка, которая была объявлена в пункте 3).
